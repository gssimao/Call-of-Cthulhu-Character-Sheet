...
{
    class Salesperson : Characteristic
    {
        public readonly string _occupationTitle = "Salesperson";

        public readonly string _creditRating = "9-40";
        public string _suggestedContacts = "Businesses within the same sector, favored customers.";
        public string OccupationSkills = "Accounting, two interpersonal skills (Charm, Fast Talk, Intimidate, or Persuade), Drive Auto, Listen, Psychology, Stealth or Sleight of Hand, any one other skill.";
        ...
        public Salesperson(bool random) // this is a random accountant
        {
            CharAge = 0;
