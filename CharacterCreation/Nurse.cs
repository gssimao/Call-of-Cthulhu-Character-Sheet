...
{
    class Nurse : Characteristic
    {
        public readonly string _occupationTitle = "Nurse";

        public readonly string _creditRating = "9-30";
        public string _suggestedContacts = "Hospital workers, physicians, community workers.";
        public string OccupationSkills = "First Aid, Listen, Medicine, one interpersonal skill(Charm, Fast Talk, Intimidate, or Persuade), Psychology, Science(Biology) and(Chemistry), Spot Hidden.";
        ...
        public Nurse(bool random) // this is a random accountant
        {
            CharAge = 0;
