...
{
    class AntiqueDealer : Characteristic
    {
        public readonly string _occupationTitle = "Antique Dealer";

        public readonly string _creditRating = "30 - 50";
        public string _suggestedContacts = "Local historians, other antique dealers, possibly criminal fences.";
        public string OccupationSkills = "Accounting, Appraise, Drive Auto, two interpersonal skills(Charm, Fast Talk, Intimidate, or Persuade), History, Library Use, Navigate.";
        public int SelectMoreSkills = 0;
        public AntiqueDealer()
        {
        ...
        public AntiqueDealer(bool random) // this is a random accountant
        {
            CharAge = 0;
