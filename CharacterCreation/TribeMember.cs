...
{
    class TribeMember : Characteristic
    {
        public readonly string _occupationTitle = "Tribe Member";

        public readonly string _creditRating = "0-15";
        public string _suggestedContacts = "Fellow tribe members.";
        public string OccupationSkills = "Climb, Fighting or Throw, Listen, Natural World, Occult, Spot Hidden, Swim, Survival (any).";
        ...
        public TribeMember(bool random) // this is a random accountant
        {
            CharAge = 0;
