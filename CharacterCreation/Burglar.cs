...
{
    class Burglar : Characteristic
    {
        public readonly string _occupationTitle = "Burglar";

        public readonly string _creditRating = "5 - 40";
        public string _suggestedContacts = "Fences, other burglars.";
        public string OccupationSkills = "Appraise, Climb, Electrical or Mechanical Repair, Listen, Locksmith, Sleight of Hand, Stealth, Spot Hidden.";
        ...
        public Burglar(bool random) // this is a random accountant
        {
            CharAge = 0;
