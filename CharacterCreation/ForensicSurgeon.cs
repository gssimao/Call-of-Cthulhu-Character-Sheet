...
{
    class ForensicSurgeon : Characteristic
    {
        public readonly string _occupationTitle = "Forensic Surgeon";

        public readonly string _creditRating = "40 - 60";
        public string _suggestedContacts = "Laboratories, law enforcement, medical profession.";
        public string OccupationSkills = "Other Language (Latin), Library Use, Medicine, Persuade, Science(Biology), (Forensics), (Pharmacy), Spot Hidden.";
        public int SelectMoreSkills = 0; 
        public ForensicSurgeon()
        {
        ...
        public ForensicSurgeon(bool random) // this is a random accountant
        {
            CharAge = 0;
