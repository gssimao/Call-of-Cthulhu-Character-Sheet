...
{
    class Bootlegger : Characteristic
    {
        public readonly string _occupationTitle = "Bootlegger";

        public readonly string _creditRating = "5 - 30";
        public string _suggestedContacts = "Organized crime, street-level law enforcement, local traders.";
        public string OccupationSkills = "Drive Auto, Fighting, Firearms, two interpersonal skills(Charm, Fast Talk, Intimidate, or Persuade), Psychology, Stealth, Spot Hidden.";
        ...
        public Bootlegger(bool random) // this is a random accountant
        {
            CharAge = 0;
