...
{
    class Gambler : Characteristic
    {
        public readonly string _occupationTitle = "Gambler";

        public readonly string _creditRating = "8 - 50";
        public string _suggestedContacts = "Bookies, organized crime, street scene.";
        public string OccupationSkills = "Accounting, Art/Craft (Acting), two interpersonal skills(Charm, Fast Talk, Intimidate, or Persuade), Listen, Psychology, Sleight of Hand, Spot Hidden.";
        ...
        public Gambler(bool random) // this is a random accountant
        {
            CharAge = 0;
