...
{
    class Outdoorswoman : Characteristic
    {
        public readonly string _occupationTitle = "Outdoorswoman";

        public readonly string _creditRating = "5-20";
        public string _suggestedContacts = "Local people and native folk, traders.";
        public string OccupationSkills = "Firearms, First Aid, Listen, Natural World, Navigate, Spot Hidden, Survival (any), Track.";
        public int SelectMoreSkills = 0; 
        public Outdoorswoman()
        {
        ...
        public Outdoorswoman(bool random) // this is a random accountant
        {
            CharAge = 0;
