...
{
    class Shopkeeper : Characteristic
    {
        public readonly string _occupationTitle = "Shopkeeper";

        public readonly string _creditRating = "20-40";
        public string _suggestedContacts = "Local residents and businesses, local police, local government, customers.";
        public string OccupationSkills = "Accounting, two interpersonal skills (Charm, Fast Talk, Intimidate, or Persuade), Electrical Repair, Listen, Mechanical Repair, Psychology, Spot Hidden.";
        ...
        public Shopkeeper(bool random) // this is a random accountant
        {
            CharAge = 0;
