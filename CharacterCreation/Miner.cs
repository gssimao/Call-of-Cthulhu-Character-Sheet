...
{
    class Miner : Characteristic
    {
        public readonly string _occupationTitle = "Miner";

        public readonly string _creditRating = "9  - 30";
        public string _suggestedContacts = "Union officials, political organizations.";
        public string OccupationSkills = "Climb, Geology, Jump, Mechanical Repair, Operate Heavy Machinery, Stealth, Spot Hidden, any one other skill as a personal or era specialty.";
        ...
        public Miner(bool random) // this is a random accountant
        {
            CharAge = 0;
