...
{
    class ElectedOfficial : Characteristic
    {
        public readonly string _occupationTitle = "Elected Official";

        public readonly string _creditRating = "50 - 90";
        public string _suggestedContacts = "Political operatives, government, news media, business, foreign governments, possibly organized crime.";
        public string OccupationSkills = "Charm, History, Intimidate, Fast Talk, Listen, Own Language, Persuade, Psychology.";
        ...
        public ElectedOfficial(bool random) // this is a random accountant
        {
            CharAge = 0;
