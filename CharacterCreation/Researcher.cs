...
{
    class Researcher : Characteristic
    {
        public readonly string _occupationTitle = "Researcher";

        public readonly string _creditRating = "9-30";
        public string _suggestedContacts = "Scholars and academics, large businesses and corporations, foreign governments and individuals.";
        public string OccupationSkills = "History, Library Use, one interpersonal skill  (Charm, Fast Talk Intimidate, or Persuade), Other Language, Spot Hidden, any three fields of study.";
        ...
        public Researcher(bool random) // this is a random accountant
        {
            CharAge = 0;
