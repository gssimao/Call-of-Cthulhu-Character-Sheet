...
{
    class MuseumCurator : Characteristic
    {
        public readonly string _occupationTitle = "Museum Curator";

        public readonly string _creditRating = "10-30";
        public string _suggestedContacts = "Local universities and scholars, publishers, museum patrons.";
        public string OccupationSkills = "Accounting, Appraise, Archaeology, History, Library Use, Occult, Other Language, Spot Hidden.";
        public int SelectMoreSkills = 0; 
        public MuseumCurator()
        {
        ...
        public MuseumCurator(bool random) // this is a random accountant
        {
            CharAge = 0;
