...
{
    class Spy : Characteristic
    {
        public readonly string _occupationTitle = "Spy";

        public readonly string _creditRating = "20-60";
        public string _suggestedContacts = "Generally only the person the spy reports to, possibly other connections developed while under cover.";
        public string OccupationSkills = "Art/Craft (Acting) or Disguise, Firearms, Listen, Other Language, one interpersonal skill(Charm, Fast Talk, Intimidate, or Persuade), Psychology, Sleight of Hand, Stealth.";
        ...
        public Spy(bool random) // this is a random accountant
        {
            CharAge = 0;
