...
{
    class Clergy : Characteristic
    {
        public readonly string _occupationTitle = "Clergy";

        public readonly string _creditRating = "9 - 60";
        public string _suggestedContacts = "Church hierarchy, local congregations, community leaders.";
        public string OccupationSkills = "Accounting, History, Library Use, Listen, Other Language, one interpersonal skill(Charm, Fast Talk, Intimidate, or Persuade), Psychology, any one other skill.";
        ...
        public Clergy(bool random) // this is a random accountant
        {
            CharAge = 0;
