...
{
    class Cowgirl : Characteristic
    {
        public readonly string _occupationTitle = "Cowgirl";

        public readonly string _creditRating = "9 - 20";
        public string _suggestedContacts = "Local businesspeople, state agricultural departments, rodeo promoters, and entertainers.";
        public string OccupationSkills = "Dodge, Fighting or Firearms, First Aid or Natural World, Jump, Ride, Survival(any), Throw, Track.";
        ...
        public Cowgirl(bool random) // this is a random accountant
        {
            CharAge = 0;
