...
{
    class Student : Characteristic
    {
        public readonly string _occupationTitle = "Student";

        public readonly string _creditRating = "5-10";
        public string _suggestedContacts = "Academics and other students, while interns may also know business people.";
        public string OccupationSkills = "Language (Own or Other), Library Use, Listen, three fields of study and any two other skills as a personal or era specialties.";
        ...
        public Student(bool random) // this is a random accountant
        {
            CharAge = 0;
