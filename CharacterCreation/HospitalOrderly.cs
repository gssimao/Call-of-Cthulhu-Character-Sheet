...
{
    class HospitalOrderly : Characteristic
    {
        public readonly string _occupationTitle = "Hospital Orderly";

        public readonly string _creditRating = "6 - 15";
        public string _suggestedContacts = "Hospital and medical workers, patients.Access to drugs, medical records, etc.";
        public string OccupationSkills = "Electrical Repair, one interpersonal skill (Charm, Fast Talk, Intimidate, or Persuade), Fighting(Brawl), First Aid, Listen, Mechanical Repair, Psychology, Stealth.";
        public int SelectMoreSkills = 0; 
        public HospitalOrderly()
        {
        ...
        public HospitalOrderly(bool random) // this is a random accountant
        {
            CharAge = 0;
