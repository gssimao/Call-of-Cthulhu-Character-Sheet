...
{
    class Laborer : Characteristic
    {
        public readonly string _occupationTitle = "Laborer";

        public readonly string _creditRating = "9  - 30";
        public string _suggestedContacts = "Other workers and supervisors within their industry.";
        public string OccupationSkills = "Drive Auto, Electrical Repair, Fighting, First Aid, Mechanical Repair, Operate Heavy Machinery, Throw, any one other skill as a personal or era specialty.";
        ...
        public Laborer(bool random) // this is a random accountant
        {
            CharAge = 0;
