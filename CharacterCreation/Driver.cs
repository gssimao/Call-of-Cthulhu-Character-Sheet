...
{
    class Driver : Characteristic
    {
        public readonly string _occupationTitle = "Driver";

        public readonly string _creditRating = "9 - 30";
        public string _suggestedContacts = "Coast guard, ship captains, military, law enforcement, smugglers.";
        public string OccupationSkills = "Diving, First Aid, Mechanical Repair, Pilot (Boat), Science(Biology), Spot Hidden, Swim, any one other skill as personal or era specialty.";
        ...
        public Driver(bool random) // this is a random accountant
        {
            CharAge = 0;
