...
{
    class Waitress : Characteristic
    {
        public readonly string _occupationTitle = "Union Activist";

        public readonly string _creditRating = "9-20";
        public string _suggestedContacts = "Customers, organized crime.";
        public string OccupationSkills = "Accounting, Art/Craft (any), Dodge, Listen, two interpersonal skills(Charm, Fast Talk, Intimidate, or Persuade), Psychology, any one skill as a personal or era specialty. Students tend";
        ...
        public Waitress(bool random) // this is a random accountant
        {
            CharAge = 0;
