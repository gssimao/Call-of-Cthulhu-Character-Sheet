...
{
    class DoctorOfMedicine : Characteristic
    {
        public readonly string _occupationTitle = "Doctor Of Medicine";

        public readonly string _creditRating = "30 - 80";
        public string _suggestedContacts = "Other physicians, medical workers, patients and ex-patients.";
        public string OccupationSkills = "First Aid, Medicine, Other Language (Latin), Psychology, Science(Biology and Pharmacy), any two other skills as academic or personal specialties.";
        ...
        public DoctorOfMedicine(bool random) // this is a random accountant
        {
            CharAge = 0;
