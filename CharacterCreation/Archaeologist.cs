...
{
    class Archaeologist : Characteristic
    {
        public readonly string _occupationTitle = "Archaeologist";

        public readonly string _creditRating = "10 - 40";
        public string _suggestedContacts = "Patrons, museums, universities.";
        public string OccupationSkills = "Appraise, Archaeology, History, Other Language (any), Library Use, Spot Hidden, Mechanical Repair, Navigate or Science(e.g.chemistry, physics, geology, etc.)";
        ...
        public Archaeologist(bool random) // this is a random accountant
        {
            CharAge = 0;
