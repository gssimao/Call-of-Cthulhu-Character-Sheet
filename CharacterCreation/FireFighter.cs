...
{
    class FireFighter : Characteristic
    {
        public readonly string _occupationTitle = "FireFighter";

        public readonly string _creditRating = "9 - 30";
        public string _suggestedContacts = "Civic workers, medical workers, law enforcement.";
        public string OccupationSkills = "Climb, Dodge, Drive Auto, First Aid, Jump, Mechanical Repair, Operate Heavy Machinery, Throw.";
        ...
        public FireFighter(bool random) // this is a random accountant
        {
            CharAge = 0;
