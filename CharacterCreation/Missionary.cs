...
{
    class Missionary : Characteristic
    {
        public readonly string _occupationTitle = "Military Officer";

        public readonly string _creditRating = "0-30";
        public string _suggestedContacts = "Church hierarchy, foreign officials.";
        public string OccupationSkills = "Art/Craft (any), First Aid, Mechanical Repair, Medicine, Natural World, one interpersonal skill (Charm, Fast Talk, Intimidate, or Persuade), any two other skills as personal or era specialties.";
        ...
        public Missionary(bool random) // this is a random accountant
        {
            CharAge = 0;
