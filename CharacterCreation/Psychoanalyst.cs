...
{
    class Psychoanalyst : Characteristic
    {
        public readonly string _occupationTitle = "Psychoanalyst";

        public readonly string _creditRating = "10-40";
        public string _suggestedContacts = "Psychological community, patients.";
        public string OccupationSkills = "Accounting, Library Use, Listen, Persuade, Psychoanalysis, Psychology, any two other skills as academic, era or personal specialties.";
        public int SelectMoreSkills = 0; 
        public Psychoanalyst()
        {
        ...
        public Psychoanalyst(bool random) // this is a random accountant
        {
            CharAge = 0;
