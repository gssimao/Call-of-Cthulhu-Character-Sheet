...
{
    class Zealot : Characteristic
    {
        public readonly string _occupationTitle = "Zealot";

        public readonly string _creditRating = "0-30";
        public string _suggestedContacts = "Religious or fraternal groups, news media.";
        public string OccupationSkills = "History, two interpersonal skills (Charm, Fast Talk, Intimidate, or Persuade), Psychology, Stealth, and any three other skills as personal or era specialties.";
        ...
        public Zealot(bool random) // this is a random accountant
        {
            CharAge = 0;
