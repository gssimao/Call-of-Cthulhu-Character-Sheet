...
{
    class LaboratoryAssistant : Characteristic
    {
        public readonly string _occupationTitle = "Laboratory Assistant";

        public readonly string _creditRating = "10  - 30";
        public string _suggestedContacts = "Universities, scientists, librarians.";
        public string OccupationSkills = "Computer Use or Library Use, Electrical Repair, Other Language, Science (Chemistry and two others), Spot Hidden, any one other skill as a personal specialty.";
        ...
        public LaboratoryAssistant(bool random) // this is a random accountant
        {
            CharAge = 0;
