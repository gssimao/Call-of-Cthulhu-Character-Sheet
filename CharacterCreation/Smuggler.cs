...
{
    class Smuggler : Characteristic
    {
        public readonly string _occupationTitle = "Smuggler";

        public readonly string _creditRating = "20 - 60";
        public string _suggestedContacts = "Organized crime, Coast Guard, U.S.Customs officials.";
        public string OccupationSkills = "Firearms, Listen, Navigate, one interpersonal skill (Charm, Fast Talk, Intimidate, or Persuade), Drive Auto or Pilot(Aircraft or Boat), Psychology, Sleight of Hand, Spot Hidden.";
        ...
        public Smuggler(bool random) // this is a random accountant
        {
            CharAge = 0;
