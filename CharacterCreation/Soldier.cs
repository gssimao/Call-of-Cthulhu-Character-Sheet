...
{
    class Soldier : Characteristic
    {
        public readonly string _occupationTitle = "Soldier";

        public readonly string _creditRating = "9-30";
        public string _suggestedContacts = "Military, veterans associations.";
        public string OccupationSkills = "Climb or Swim, Dodge, Fighting, Firearms, Stealth, Survival and two of the following: First Aid, Mechanical Repair or Other Language.";
        ...
        public Soldier(bool random) // this is a random accountant
        {
            CharAge = 0;
