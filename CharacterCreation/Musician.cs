...
{
    class Musician : Characteristic
    {
        public readonly string _occupationTitle = "Musician";

        public readonly string _creditRating = "9-30";
        public string _suggestedContacts = "Club owners, musicians’ union, organized crime, street-level criminals.";
        public string OccupationSkills = "Art/Craft (Instrument), one interpersonal skill (Charm, Fast Talk, Intimidate, or Persuade), Listen, Psychology, any four other skills.";
        ...
        public Musician(bool random) // this is a random accountant
        {
            CharAge = 0;
