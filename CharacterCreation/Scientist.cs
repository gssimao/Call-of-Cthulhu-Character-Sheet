...
{
    class Scientist : Characteristic
    {
        public readonly string _occupationTitle = "Salesperson";

        public readonly string _creditRating = "9-50";
        public string _suggestedContacts = "Other scientists and academics, universities, their employers and former employers.";
        public string OccupationSkills = "Any three science specialisms, Computer Use or Library Use, Other Language, Own Language, one interpersonal skill(Charm, Fast Talk, Intimidate, or Persuade), Spot Hidden.";
        ...
        public Scientist(bool random) // this is a random accountant
        {
            CharAge = 0;
