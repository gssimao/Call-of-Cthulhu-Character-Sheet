...
{
    class Author : Characteristic
    {
        public readonly string _occupationTitle = "Author";

        public readonly string _creditRating = "9 - 30";
        public string _suggestedContacts = "publishers, critics, historians, etc.";
        public string OccupationSkills = "Art (Literature), History, Library Use, Natural World or Occult, Other Language, Own Language, Psychology, any one other skill as a personal or era specialty.";
        ...
        public Author(bool random) // this is a random accountant
        {
            CharAge = 0;
