...
{
    class Undertaker : Characteristic
    {
        public readonly string _occupationTitle = "Undertaker";

        public readonly string _creditRating = "20-40";
        public string _suggestedContacts = "Few.";
        public string OccupationSkills = "Accounting, Drive Auto, one interpersonal skill (Charm, Fast Talk, Intimidate, or Persuade), History, Occult, Psychology, Science (Biology) and(Chemistry).";
        ...
        public Undertaker(bool random) // this is a random accountant
        {
            CharAge = 0;
