...
{
    class Pilot : Characteristic
    {
        public readonly string _occupationTitle = "Pilot";

        public readonly string _creditRating = "20-70";
        public string _suggestedContacts = "Old military contacts, cabin crew, mechanics, airfield staff, carnival entertainers.";
        public string OccupationSkills = "Electrical Repair, Mechanical Repair, Navigate, Operate Heavy Machine, Pilot (Aircraft), Science (Astronomy), any two other skills as personal or era specialties.";
        ...
        public Pilot(bool random) // this is a random accountant
        {
            CharAge = 0;
