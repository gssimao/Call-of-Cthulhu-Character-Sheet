...
{
    class Photographer : Characteristic
    {
        public readonly string _occupationTitle = "Photographer";

        public readonly string _creditRating = "9-30";
        public string _suggestedContacts = "Advertising industry, local clients (including political organizations and newspapers).";
        public string OccupationSkills = "Art/Craft (Photography), one interpersonal skill (Charm, Fast Talk, Intimidate, or Persuade), Psychology, Science (Chemistry), Stealth, Spot Hidden, any two other skills as personal or era specialties.";
        ...
        public Photographer(bool random) // this is a random accountant
        {
            CharAge = 0;
