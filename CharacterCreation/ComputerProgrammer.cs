...
{
    class ComputerProgrammer : Characteristic
    {
        public readonly string _occupationTitle = "Computer Programmer";

        public readonly string _creditRating = "10 - 70";
        public string _suggestedContacts = "Other IT workers, corporate workers and managers, specialized Internet web communities.";
        public string OccupationSkills = "Computer Use, Electrical Repair, Electronics, Library Use, Science(Mathematics), Spot Hidden, any two other skills as personal or era specialties.";
        public int SelectMoreSkills = 0;
        public ComputerProgrammer()
        {
        ...
        public ComputerProgrammer(bool random) // this is a random accountant
        {
            CharAge = 0;
