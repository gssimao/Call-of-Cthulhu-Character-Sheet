...
{
    class Lawyer : Characteristic
    {
        public readonly string _occupationTitle = "Lawyer ";

        public readonly string _creditRating = "30  - 80";
        public string _suggestedContacts = "Organized crime, financiers, district attorneys and judges.";
        public string OccupationSkills = "Accounting, Law, Library use, two interpersonal skills(Charm, Fast Talk, Intimidate, or Persuade), Psychology, any two other skills.";
        ...
        public Lawyer(bool random) // this is a random accountant
        {
            CharAge = 0;
