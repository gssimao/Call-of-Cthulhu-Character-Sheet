...
{
    class Sailor : Characteristic
    {
        public readonly string _occupationTitle = "Sailor";

        public readonly string _creditRating = "9-30";
        public string _suggestedContacts = "Military, veterans’ associations.";
        public string OccupationSkills = "Electrical or Mechanical Repair, Fighting, Firearms, First Aid, Navigate, Pilot (Boat), Survival (Sea), Swim.";
        ...
        public Sailor (bool random) // this is a random accountant
        {
            CharAge = 0;
