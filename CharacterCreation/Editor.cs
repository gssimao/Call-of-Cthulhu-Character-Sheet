...
{
    class Editor : Characteristic
    {
        public readonly string _occupationTitle = "Editor";

        public readonly string _creditRating = "10 - 30";
        public string _suggestedContacts = "News industry, local government, specialists(e.g.fashion designers, sports, business), publishers.";
        public string OccupationSkills = "Accounting, History, Own Language, two interpersonal skills(Charm, Fast Talk, Intimidate, or Persuade), Psychology, Spot Hidden, any one other skill as personal or era specialty.";
        ...
        public Editor(bool random) // this is a random accountant
        {
            CharAge = 0;
