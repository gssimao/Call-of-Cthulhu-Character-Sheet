...
{
    class Architect : Characteristic
    {
        public readonly string _occupationTitle = "Architect";

        public readonly string _creditRating = "30 - 70";
        public string _suggestedContacts = "Local building and city engineering departments, construction firms.";
        public string OccupationSkills = "Accounting, Art/Craft (Technical Drawing), Law, Own Language, Computer Use or Library Use, Persuade, Psychology, Science (Mathematics).";
        ...
        public Architect(bool random) // this is a random accountant
        {
            CharAge = 0;
