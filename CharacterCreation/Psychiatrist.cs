...
{
    class Psychiatrist : Characteristic
    {
        public readonly string _occupationTitle = "Psychiatrist";

        public readonly string _creditRating = "30-80";
        public string _suggestedContacts = "Others in the field of mental illness, physicians and possibly legal professions.";
        public string OccupationSkills = "Other Language, Listen, Medicine, Persuade, Psychoanalysis, Psychology, Science (Biology) and(Chemistry).";
        ...
        public Psychiatrist(bool random) // this is a random accountant
        {
            CharAge = 0;
