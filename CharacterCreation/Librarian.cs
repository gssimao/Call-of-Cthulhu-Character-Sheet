...
{
    class Librarian : Characteristic
    {
        public readonly string _occupationTitle = "Librarian";

        public readonly string _creditRating = "9  - 35";
        public string _suggestedContacts = "Booksellers, community groups, specialist researchers.";
        public string OccupationSkills = "Accounting, Library use, Other Language, Own Language, any four other skills as personal specialties or specialist reading topics.";
        ...
        public Librarian(bool random) // this is a random accountant
        {
            CharAge = 0;
